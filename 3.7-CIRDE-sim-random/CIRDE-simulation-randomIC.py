...
Eyre-Type Semi-Implicit Time Stepping with Uniform Random Initial Data
...
The initial condition is generated by sampling independent values from

    Uniform[random_low, random_high]

at the interior grid points and setting all boundary values equal to zero.
...
def random_dirichlet_initial_condition(
    M,
    low=RANDOM_LOW,
    high=RANDOM_HIGH,
    seed=RANDOM_SEED,
    ...
    at the interior grid points. Boundary values are set equal to zero
...
def main():
    ...
    if initial_data_path.exists():
        ...
        print(
            "Loading existing uniform random initial condition..."
        )
        ...
        print(
            "Generating uniform random initial condition..."
        )

        u = random_dirichlet_initial_condition(
            M=M,
            low=RANDOM_LOW,
            high=RANDOM_HIGH,
            seed=RANDOM_SEED,
    ...
    for step in range(
        ...
        # ---------------------------------------------------------------------
        # Check discrete Lyapunov-energy decay
        # ---------------------------------------------------------------------
