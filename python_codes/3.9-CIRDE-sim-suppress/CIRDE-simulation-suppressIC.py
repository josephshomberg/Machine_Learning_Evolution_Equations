...
INITIAL_AMPLIFUDE = 0.02  # base amplitude scaling for engineered sine-mode initial data
...
def engineered_sine_ic(M, L, amp_low=-INITIAL_AMPLIFUDE, amp_high=INITIAL_AMPLIFUDE):
    """
...
def main():
    ...
    if initial_data_path.exists():
        ...
        u = engineered_sine_ic(M, L, amp_low=INITIAL_AMPLIFUDE, amp_high=INITIAL_AMPLIFUDE)
